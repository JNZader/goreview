 ...
 */
export async function handlePullRequest(action, payload) {
    const pr = payload;
 ...
 */
export async function processReviewJob(installationId, owner, repo, pullNumber, headSha) {
    ...
    try {
        ...
        // Perform the review
        const result = await prReviewService.reviewPR(octokit, owner, repo, pullNumber);
        // Post review comments
        await commentService.postReview(octokit, owner, repo, pullNumber, result);
